module Player
  module IncreaseLevel
    def self.call(structure, target_subskill_name, new_subskill)
      ...
      structure.each do |item|
        item.each do |key, value|
          if key == :subskills && value.is_a?(Array) && !value.empty?
            ...
            self.call(updated_subskills, target_subskill_name, new_subskill)
          end
        end
      end
      ...
      Display.skills('Fulano', $player_skills)
    end
  end
end